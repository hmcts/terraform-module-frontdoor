...
resource "azurerm_cdn_frontdoor_route" "routing_rule_A" {
  ...
  cdn_frontdoor_rule_set_ids      = local.cache ? [azurerm_cdn_frontdoor_rule_set.caching_ruleset[each.key].id] : []
  enabled                         = true
...
resource "azurerm_cdn_frontdoor_route" "routing_rule_B" {
  ...
  cdn_frontdoor_origin_ids        = [azurerm_cdn_frontdoor_origin.defaultBackend_origin.id]
  cdn_frontdoor_custom_domain_ids = [azurerm_cdn_frontdoor_custom_domain.custom_domain[each.key].id]
  cdn_frontdoor_rule_set_ids      = local.cache ? [azurerm_cdn_frontdoor_rule_set.https_redirect.id, azurerm_cdn_frontdoor_rule_set.caching_ruleset[each.key].id] : [azurerm_cdn_frontdoor_rule_set.https_redirect.id]
  enabled                         = true
...
resource "azurerm_cdn_frontdoor_route" "routing_rule_C" {
  ...
  cdn_frontdoor_rule_set_ids      = local.cache ? [azurerm_cdn_frontdoor_rule_set.www_redirect_rule_set[each.key].id, azurerm_cdn_frontdoor_rule_set.caching_ruleset[each.key].id] : [azurerm_cdn_frontdoor_rule_set.www_redirect_rule_set[each.key].id]
  enabled                         = true
...
resource "azurerm_cdn_frontdoor_route" "routing_rule_D" {
  ...
  cdn_frontdoor_custom_domain_ids = [azurerm_cdn_frontdoor_custom_domain.custom_domain[each.key].id]
  cdn_frontdoor_rule_set_ids      = local.cache ? [azurerm_cdn_frontdoor_rule_set.redirect_hostname_rule_set[each.key].id, azurerm_cdn_frontdoor_rule_set.caching_ruleset[each.key].id] : [azurerm_cdn_frontdoor_rule_set.redirect_hostname_rule_set[each.key].id]
  enabled                         = true
